...
if(isset($_POST['submit']))
  {
    ...
    $roles_services = $_POST['roles_services'];
    $credits_design = $_POST['credits_design'];
    $credits_copy = $_POST['credits_copy'];
    $location_year = $_POST['location_year'];
    $cat_id = $_POST['cat_id'];
    $date = date("d M, Y");
    $current_wallpaper = $_POST['current_wallpaper'];
    $current_website_video = $_POST['current_website_video'];
    $current_mobile1_website_image = $_POST['current_mobile1_website_image'];
    $current_mobile2_website_image = $_POST['current_mobile2_website_image'];
    $current_mobile_website_video = $_POST['current_mobile_website_video'];
    $current_tablet_website_video = $_POST['current_tablet_website_video'];
    $current_tablet_website_section_video = $_POST['current_tablet_website_section_video'];
    ...
    {
      //Category Updated
      $msg = "<div class='alert alert-success'>Archive updated successful.</div>";
    }
    else
    {
      //Failed to Updated Category
      //Category Updated
    $msg = "<div class='alert alert-danger'>Archive Failed to update.</div>";
    }
  }
        ...
        <div class="row">
            <div class="col-lg-8 col-12 mx-auto bg-white p-4 shadow">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <?php } } ?>
                    <button type="submit" name="submit" class="btn btn-primary">Update Archive</button>
                </form>
            </div>
        </div>

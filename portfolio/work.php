...
<head>
    <meta charset="UTF-8" />
        ...
        <link rel="canonical" href="work.php">
        ...
        <main class="main" id="work" data-barba="container" data-barba-namespace="work" >
                ...
                <div class="mouse-pos-list-image-bounce overlay">
                    <div class="float-image-wrap">
                            ...
                            <div class="overlay overlay-image lazy" style="background-color: #DCD0C2; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/future-goals/3eafae1c56-1653057688/thumbnail-futuregoals-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner development interaction visible">
                            <div class="overlay overlay-image lazy" style="background-color: #E2D1D9; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/chainn/3b2965a4d4-1646837292/thumbnail-chainn-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner development interaction visible">
                            <div class="overlay overlay-image lazy" style="background-color: #B1A994; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/atypikal/772a7bc7f2-1646837277/thumbnail-atypikal-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner development interaction visible">
                            <div class="overlay overlay-image lazy" style="background-color: #373737; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/micdrop-agency/f49041aa3c-1646837247/thumbnail-micdrop-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner design interaction development visible">
                            <div class="overlay overlay-image lazy" style="background-color: #C2C2C2; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/tapsody/693cddafe2-1646837238/thumbnail-tapsody-v5-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner design interaction development visible">
                            <div class="overlay overlay-image lazy" style="background-color: #E49C4A; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/emble-studio/cb063dfbe5-1646837261/thumbnail-emble-yellow-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner development interaction visible">
                            <div class="overlay overlay-image lazy" style="background-color: var(--color-lightgray); background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/one-nil/4906e66370-1646837272/thumbnail-onenil-v3-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner design development visible">
                            <div class="overlay overlay-image lazy" style="background-color: #626D6E; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/andy-hardy/592a7aa938-1646837253/thumbnail-andyhardy-810x810-crop-q72.jpg"></div>                        </li>
                                                <li class="mouse-pos-list-image-inner design development interaction visible">
                            <div class="overlay overlay-image lazy" style="background-color: #C9C9C9; background-position: center center; background-repeat: no-repeat; background-size: cover;" data-bg="media/pages/work/sunlight/bb0e08d2c5-1646837283/thumbnail-sunlight-v3-810x810-crop-q72.jpg"></div>                        </li>
                                            </div>
                </div>
            </div>
         ...
         <div class="toggle-row">
            <div class="btn btn-normal all-btn active">
               <div class="btn-click magnetic" data-strength="25" data-strength-text="15">
                  <div class="btn-fill"></div>
                  <span class="btn-text">
                     <span class="btn-text-inner change">All<?php
                       //sql query
                         $sql5 = "SELECT * FROM work_table";
                         //execute query
                   ...
                   <div class="count-nr"><?php echo $count5; ?></div></span>
                  </span>
               </div>
            </div>
   ...
   <section class="section work-grid small-work-grid grid-fade grid-rows-part visible">
      <div class="container">
         ...
         <?php while ($row2 = mysqli_fetch_assoc($result2)) { ?>
               ...
               <a href="work/work_details.php?id=<?php echo $row2['id']; ?>&wallpaper=<?php echo $row2['wallpaper']; ?>" class="row">
                  <div class="flex-col">
                     <h4><span><?php echo $row2["work_title"]; ?></span></h4>
                  </div>
                  <div class="flex-col animate">
                     <p><?php echo $row2["location_year"]; ?></p>
                  </div>
                  <div class="flex-col animate">
                     <p><?php echo $row2["roles_services"]; ?></p>
                  </div>
                  <div class="flex-col animate">
         ...
         <ul>
           ...
           <style media="screen">
             .overlay .overlay-color{
               background: url("<?php if (file_exists('media/' . $row3['mobile1_website_image'])) { echo 'media/' . $row3['mobile1_website_image']; }?>") center center no-repeat;
             }
           </style>
                        <li class="development interaction visible">
               <div class="single-tile-wrap">
                  <a href="work/work_details.php?id=<?php echo $row3['id']; ?>&wallpaper=<?php echo $row3['wallpaper']; ?>" class="row">
                     <div class="flex-col">
                        <div class="tile-image">
                           <img class="overlay overlay-image lazy" style="background-position: center center; background-repeat: no-repeat; background-size: cover; z-index: 1000;"
                           src="<?php if (file_exists('media/' . $row3['mobile1_website_image'])) { echo 'media/' . $row3['mobile1_website_image']; }?>"
                           data-bg="<?php if (file_exists('media/' . $row3['mobile1_website_image'])) { echo 'media/' . $row3['mobile1_website_image']; }?>">
                         </div>
                     </div>
                     <div class="flex-col">
                        <h4><span><?php echo $row3['work_title']; ?></span></h4>
                        <div class="stripe"></div>
                     </div>
                     <div class="flex-col">
                        <p><?php echo $row3['roles_services']; ?></p>
                     </div>
                     <div class="flex-col">
   ...
   <div class="container">
      <div class="grid-after-btn">
         <div class="btn btn-normal btn-dark">
            <a href="archive.php" class="btn-click magnetic" data-strength="25" data-strength-text="15">
               <div class="btn-fill"></div>
               <span class="btn-text">
                 <?php
                   //sql query
                     $sql8 = "SELECT * FROM archive_table";
                     //execute query
                     $res8 = mysqli_query($conn, $sql8);
                     //Count Rows
                     $count8 = mysqli_num_rows($res8);
                    ?>
                  <span class="btn-text-inner change">Archive<div class="count-nr"><?php echo $count8; ?></div></span>
               </span>
            </a>
         </div>
      </div>
